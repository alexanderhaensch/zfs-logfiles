May 06 07:16:11 io kernel: INFO: rcu_sched self-detected stall on CPU { 2}  (t=8403 jiffies g=19038966 c=19038965 q=424842)
...
kernel: RAX: 00000000979b5275 RBX: 00000000000003e9 RCX: 00000000979b5230
kernel: RDX: 000000000005938d RSI: 0000000000000002 RDI: 000000000003344f
kernel: RBP: ffff88103fc43d78 R08: ffffffff8187c158 R09: ffffffff819a94f4
kernel: R10: 0000000000002b2b R11: 0000000000002b2a R12: 0000000000001000
...
kernel: CR2: ffffffffff600400 CR3: 0000000fad31d000 CR4: 00000000001607f0
kernel: Stack:
...
kernel:  <EOI> 
kernel: 
kernel:  [<ffffffffa0b53ca6>] ? dmu_zfetch+0x406/0x1b90 [zfs]
kernel:  [<ffffffff815da4e6>] ? __mutex_unlock_slowpath+0x86/0x120
kernel:  [<ffffffff815da589>] mutex_unlock+0x9/0x10
kernel:  [<ffffffffa0b3d65e>] dbuf_evict+0x2ee/0x5c0 [zfs]
kernel:  [<ffffffffa0b3d99e>] dbuf_hold_impl+0x6e/0x90 [zfs]
kernel:  [<ffffffffa0be7660>] ? cleanup_module+0x16ad/0x35235 [zfs]
kernel:  [<ffffffffa0b3dc7b>] dbuf_hold+0x1b/0x30 [zfs]
kernel:  [<ffffffffa0b557f7>] dnode_hold_impl+0x157/0x5a0 [zfs]
